...
def setup_exp():
    e = ExpMan(node_count=6,
               title="Malicious Behaviour Trust AAMAS Control",
               parallel=True,
...
if __name__ == "__main__":
    ...
    try:
        ...
        #
        #     outliers = rwc.perform_weight_factor_run_comparative_outlier_analysis_on_trust_frame(sub_frame, "CombinedTrust", extra=run, min_emphasis=0,
